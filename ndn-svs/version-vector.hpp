...
public:
  ...
  /** Decode the legacy SVS V2 Name+SeqNo state-vector layout. */
  static VersionVector decodeV2(const ndn::Block& encoded);

  /** Encode the version vector to a string */
  ndn::Block encode() const;

  /** Encode the legacy SVS V2 Name+SeqNo state-vector layout. */
  ndn::Block encodeV2() const;
