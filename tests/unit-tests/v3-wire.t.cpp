...
{
  Interest interest(SyncProtocolCodec::makeSyncName("/ndn/svs-v3-test", version));
...
BOOST_AUTO_TEST_CASE(V2RemainsExplicitAndRaw)
{
  auto decoded = SyncProtocolCodec::decode(
    ...
    "/ndn/svs-v3-test", SvsProtocolVersion::V2);
  ...
  auto encoded = SyncProtocolCodec::encode("/ndn/svs-v3-test", vector, {}, profile.resolve(), {});
  ...
  auto compressedDecoded = SyncProtocolCodec::decode(encoded, "/ndn/svs-v3-test",
